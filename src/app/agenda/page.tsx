        ...
        <div className="relative z-10">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <button
                onClick={() => openModal()}
                className="bg-white/20 dark:bg-slate-800/20 backdrop-blur-lg border border-white/30 text-white px-4 md:px-6 py-3 rounded-xl flex items-center gap-2 hover:bg-white/30 transition-all duration-300 hover:scale-105 shadow-lg"
              >
                <Plus size={20} />
