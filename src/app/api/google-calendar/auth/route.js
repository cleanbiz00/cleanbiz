...
export async function GET(request) {
  ...
  try {
    ...
    const redirectUrl = `${process.env.NEXT_PUBLIC_BASE_URL || 'https://app.cleanbiz360.com'}/agenda?google_token=${encodeURIComponent(tokenData.access_token)}&refresh_token=${encodeURIComponent(tokenData.refresh_token || '')}`;
    
    console.log('✅ Token obtido com sucesso, redirecionando para:', redirectUrl);
